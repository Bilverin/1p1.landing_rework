...
$(document).ready(function() {
	...
	$('#js-countdown-1').countdown(tz1.toDate(), function(event) {
		var $this = $(this).html(event.strftime(''
			+ '<div>'
			+ '<p>%D</p><span>' + contdate1D + '</span>'
			+ '</div>'
			+ '<div>'
			+ '<p>%H</p><span>' + contdate1H + '</span>'
			+ '</div>'
			+ '<div>'
			+ '<p>%M</p><span>' + contdate1M + '</span>'
			+ '</div>'
			+ '<div>'
			+ '<p>%S</p><span>' + contdate1S + '</span>'
			+ '</div>'));
	});
	$('#js-countdown-2').countdown(tz2.toDate(), function(event) {
		var $this = $(this).html(event.strftime(''
			+ '<div>'
			+ '<p>%D</p><span>' + contdate2D + '</span>'
			+ '</div>'
			+ '<div>'
			+ '<p>%H</p><span>' + contdate2H + '</span>'
			+ '</div>'
			+ '<div>'
			+ '<p>%M</p><span>' + contdate2M + '</span>'
			+ '</div>'
			+ '<div>'
			+ '<p>%S</p><span>' + contdate2S + '</span>'
			+ '</div>'));
	});
